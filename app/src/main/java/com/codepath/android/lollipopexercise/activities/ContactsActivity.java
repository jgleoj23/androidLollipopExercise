...
public class ContactsActivity extends AppCompatActivity {
    ...
    public void onAddAction(MenuItem item) {

        // get random contact and add to the list of contacts
        final Contact randomContact = Contact.getRandomContact(this);
        ...
        Snackbar.make(rvContacts, R.string.snackbar_text, Snackbar.LENGTH_LONG)
                .setAction(R.string.snackbar_action, new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        int index = contacts.indexOf(randomContact);
                        contacts.remove(randomContact);
